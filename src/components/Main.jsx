  ...
  return (
    <>
      ...
      <div className='w-full h-screen absolute top-0 left-0 font-neon'>
        ...
        <img src={portfolioPic} className=' rounded-full object-fill h-48 w-48 md:h-64 md:w-64' alt="" />
          ...
          <div className='flex justify-between pt-2 gap-3'>
            ...
            <a href="https://github.com/Josenov" target='_blank'><FaGithub className='cursor-pointer text-white' size={35} /></a>
